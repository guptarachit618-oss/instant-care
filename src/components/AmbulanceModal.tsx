...
export default function AmbulanceModal({ hospital, userLat, userLon, onClose }: Props) {
  ...
  return (
    ...
    >
      <div
        className="relative w-full max-w-md bg-card border border-border rounded-xl shadow-card overflow-hidden animate-scale-in"
      ...
      >
        ...
        {step === 'confirmed' && (
          <div className="p-8 flex flex-col items-center justify-center animate-scale-in">
